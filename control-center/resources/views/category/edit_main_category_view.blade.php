...
<div class="row">
    <form action="{{ url('category/update_main_category') }}" method="post" enctype="multipart/form-data">    
          ...
          @csrf
          <input type="hidden" name="eid" value="<?=(!empty($update_data->category_id)) ? $update_data->category_id : "" ?>">
