<div class="row">
    ...
    <div class="col-md-12" style="margin-bottom: 10px;">
        <a href="{{ url('category/service_category') }}" class="btn btn-flat btn-primary pull-right"><i class="fa fa-building"></i> <span> View Catetory List</span></a>
    </div>
</div>
<div class="row">
  
  <form id="create_new_page_form" action="{{ url('category/store_service_category') }}" method="post" enctype="multipart/form-data">   
        ...
        <select class="form-control" name="enable" id="enable" style="width:30%">
          ...
          @csrf
          <button class="btn btn-success btn-flat create_new_page_btn" type="submit" name="create_page">Create Service Category</button>
          </div>
