...
<div class="row">
  ...
  <form action="{{ url('salon/store_salon') }}" method="post" enctype="multipart/form-data">   
          ...
          <div class="form-group col-md-4">
            ...
            <input class="form-control" name="salon_name" value="{{ old('salon_name') }}" type="text" placeholder="Salon Name" >@if($errors->has('salon_name'))<div class="error">{{ $errors->first('salon_name') }}</div>@endif
          </div>
          ...
          <div class="form-group col-md-4">
            ...
            <input class="form-control" name="phone" value="{{ old('phone') }}" type="text" placeholder="Salon phone" >@if($errors->has('phone'))<div class="error">{{ $errors->first('phone') }}</div>@endif
          </div>

          <div class="form-group col-md-4">
            <label for="title">Mobile</label>
            <input class="form-control" name="mobile" value="{{ old('mobile') }}" type="text" placeholder="Salon mobile" >@if($errors->has('mobile'))<div class="error">{{ $errors->first('mobile') }}</div>@endif
          </div>

          <div class="form-group col-md-4">
            <label for="title">Email</label>
            <input class="form-control" name="email" value="{{ old('email') }}" type="text" placeholder="Salon email" >@if($errors->has('email'))<div class="error">{{ $errors->first('email') }}</div>@endif
          </div>

          <div class="form-group col-md-4">
            <label for="title">Contact Person</label>
            <input class="form-control" name="contact_person" value="{{ old('contact_person') }}" type="text" placeholder="Salon contact person" >@if($errors->has('contact_person'))<div class="error">{{ $errors->first('contact_person') }}</div>@endif
          </div>
          ...
          <div class="form-group col-md-4">
            ...
            <input class="form-control" name="latitude" value="{{ old('latitude') }}" type="text" placeholder="Salon latitude" >@if($errors->has('latitude'))<div class="error">{{ $errors->first('latitude') }}</div>@endif
          </div>

          <div class="form-group col-md-4">
            <label for="title">Longitude</label>
            <input class="form-control" name="longitude" value="{{ old('longitude') }}" type="text" placeholder="Salon longitude" >@if($errors->has('longitude'))<div class="error">{{ $errors->first('longitude') }}</div>@endif
          </div>

          <div class="form-group col-md-4">
            <label for="title">Website</label>
            <input class="form-control" name="website" value="{{ old('website') }}" type="text" placeholder="Salon website" >@if($errors->has('website'))<div class="error">{{ $errors->first('website') }}</div>@endif
          </div>

          <div class="form-group col-md-4">
            <label for="title">PAN Number</label>
            <input class="form-control" name="pan_number" value="{{ old('pan_number') }}" type="text" placeholder="Salon PAN number" >@if($errors->has('pan_number'))<div class="error">{{ $errors->first('pan_number') }}</div>@endif
          </div>
          ...
          <div class="form-group col-md-4">
            ...
            <input class="form-control" name="gst_number" value="{{ old('gst_number') }}" type="text" placeholder="Salon GST number" >@if($errors->has('gst_number'))<div class="error">{{ $errors->first('gst_number') }}</div>@endif
          </div>
          ...
          <div class="form-group col-md-4">
            ...
            <input class="form-control" name="annual_business" value="{{ old('annual_business') }}" type="text" placeholder="Salon annual business" >@if($errors->has('annual_business'))<div class="error">{{ $errors->first('annual_business') }}</div>@endif
          </div>
        ...
        <select class="form-control" name="status">
          ...
          @csrf
          <button class="btn btn-success btn-flat" type="submit">Create Salon</button>
          </div>
