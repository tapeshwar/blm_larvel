...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/nestedSortable/jQuery-UI-v1.10.4.css')}}" />
    <link rel="stylesheet" href="{{ asset('assets/nestedSortable/nestedSortable.css')}}" />

    <link rel="stylesheet" href="{{ asset('assets/jquery-confirm/jquery-confirm.css')}}" />
    <link rel="stylesheet" href="{{ asset('assets/dist/css/AdminLTE.min.css')}}">
    <link rel="stylesheet" href="{{ asset('assets/dist/css/skins/_all-skins.min.css')}}">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600,700,300italic,400italic,600italic">
    <?php
    if(!empty($append_css)){
        echo append_css($append_css);
    }
    ?>
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="index2.html" class="logo">
                ...
                <span class="logo-lg"><b>Bloom</b>APP</span>
            </a>
            ...
            <nav class="navbar navbar-static-top">
                ...
                <div class="navbar-custom-menu">
                    ...
                    <li class="dropdown user user-menu"><a href="{{ url('projects/change_project') }}"><span class="hidden-xs" title="<?=session('project_name')?>">(<?=session('project_key')?>) Change</span></a></li>
